package com.unitycraft.citizensskinfix;
...
public class CitizensSkinFixPlugin extends JavaPlugin implements CommandExecutor {
    ...
    public void onEnable() {
        ...
        getLogger().info(" Usa /citizensskinfix en consola o en el juego");
        getLogger().info(" para probar la conectividad con Mojang.");
        getLogger().info("========================================");

        if (getCommand("citizensskinfix") != null) {
            getCommand("citizensskinfix").setExecutor(this);
        }
    }

    @Override
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (!command.getName().equalsIgnoreCase("citizensskinfix")) {
            return false;
        }
